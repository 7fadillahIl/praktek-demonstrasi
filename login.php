...
<head>
    ...
    <title>Sertifikasi Alhikmah</title>
...
<div class="row h-100">
    <div class="col-lg-5 col-12">
        <div id="auth-left">
            <div class="auth-logo">
                <a href="index.php"
                  ><img
                    src="./assets/compiled/svg/alhikmah.svg"
                    alt="jabar"
                    srcset=""
                /></a>
            </div>
            <h1 class="auth-title">Login</h1>
            <p class="auth-subtitle mb-5">Silahkan Login Sebagai Admin Alhikmah</p>
    ...
    <div class="col-lg-7 d-none d-lg-block">
        <div id="auth-right">
            <img src="./assets/compiled/jpg/alhikmah.jpeg" alt="" style="width: 100%; height: 100%;">
